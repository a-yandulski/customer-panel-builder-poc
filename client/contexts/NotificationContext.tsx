...
interface NotificationContextType {
  ...
  // Actions
  fetchNotifications: (params?: { page?: number; limit?: number; category?: string; onlyUnread?: boolean }) => Promise<void>;
...
class MockWebSocket {
  ...
  connect() {
    ...
    setTimeout(() => {
      if (Math.random() > 0.9) { // 10% chance of connection issues
        this.disconnect();
  ...
  private simulateNotification() {
    const mockNotifications = [
      ...
      },
      {
        ...
        message: "Your domain will expire in 7 days. Renew now to avoid interruption.",
