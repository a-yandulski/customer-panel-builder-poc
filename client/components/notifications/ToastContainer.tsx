...
export function ProgressToast({ id, title, progress, isIndeterminate, onCancel }: ProgressToastProps) {
      ...
      <div className="space-y-3">
        <div className="space-y-1">
          <div className="flex items-center justify-between text-xs">
            <span>Progress: {completed} of {total}</span>
          ...
          <div className="w-full bg-gray-100 rounded-full h-2">
            <div
              className={`h-2 rounded-full transition-all duration-300 ${
                errors > 0 ? 'bg-yellow-500' : isComplete ? 'bg-green-500' : 'bg-blue-500'
              }`}
        ...
        {isComplete && errors === 0 && (
          <div className="flex items-center space-x-2 text-green-700">
            ...
            <span className="text-xs">All operations completed successfully</span>
          </div>
        )}
      </div>
    </div>
