          ...
          <Dialog open={showAddCard} onOpenChange={setShowAddCard}>
            ...
            <DialogContent className="max-w-md">
              <DialogHeader>
                ...
                <DialogDescription>
                  Add a new credit card or payment method. Your information is secure and encrypted.
                </DialogDescription>
              </DialogHeader>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <Card className="shadow-md">
            ...
            <CardContent>
              ...
              <p className="body-sm text-gray-500 mt-1">No outstanding balance</p>
            </CardContent>
          </Card>
            ...
            <Card className="shadow-md">
              <CardHeader>
                ...
                <CardDescription className="body-sm">
                  Manage your credit cards and payment methods. All information is encrypted and secure.
                </CardDescription>
              </CardHeader>
                        ...
                        <div className="flex items-center space-x-4">
                          ...
                          <div>
                            <h4 className="font-semibold text-gray-900">
                              {card.type} {card.type !== "PayPal" ? `ending in ${card.last4}` : ""}
                            </h4>
                            <p className="body-sm text-gray-600">
                              {card.type === "PayPal" ? card.last4 : `Expires ${card.expiry}`} • {card.name}
                            </p>
                            <div className="flex items-center space-x-2 mt-1">
                              <Shield className="h-3 w-3 text-success" />
                              <span className="text-xs text-success">PCI Compliant</span>
                              {card.isDefault && (
                                <>
                                  <Star className="h-3 w-3 text-warning" />
                                  <span className="text-xs text-warning">Default</span>
                                </>
                              )}
                            </div>
                          </div>
                ...
                <Card className="border-2 border-dashed border-gray-300 hover:border-primary/50 transition-colors">
                  <CardContent className="pt-8 pb-8">
                    <div className="text-center">
                      ...
                      <p className="body text-gray-600 mb-4">Add a new payment method</p>
                      <Dialog open={showAddCard} onOpenChange={setShowAddCard}>
                        <DialogTrigger asChild>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          ...
                          <p className="body-sm text-gray-600">{subscription.plan}</p>
                      ...
                      <div className="flex items-center space-x-4">
                        <div className="text-right">
                          ...
                          <div className="flex items-center space-x-2 mt-2">
                            <Label htmlFor={`auto-renew-${subscription.id}`} className="body-sm text-gray-600">
                              Auto-renewal:
                            </Label>
                            <Switch
                              id={`auto-renew-${subscription.id}`}
                              checked={subscription.autoRenewal}
                              onCheckedChange={() => toggleSubscriptionRenewal(subscription.id)}
                            />
                          </div>
                        </div>
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-4">
                    <h4 className="font-semibold text-gray-900">Recent Credit Activity</h4>
                    <div className="space-y-3">
                      <div className="flex justify-between items-center p-3 bg-gray-50 rounded">
                        ...
                        <span className="text-success font-semibold">+$50.00</span>
                      </div>
                      <div className="flex justify-between items-center p-3 bg-gray-50 rounded">
                        <div>
                          <p className="body-sm font-medium">Payment Deducted</p>
                          <p className="text-xs text-gray-500">Nov 28, 2024</p>
                        </div>
                        <span className="text-gray-900 font-semibold">-$22.50</span>
                      </div>
                    </div>
                  </div>
                </div>
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-center space-x-4 p-3 bg-gray-50 rounded-lg">
        ...
        <div className="flex items-center space-x-1">
          ...
          <span className="text-xs text-success font-medium">PCI Compliant</span>
        </div>
      </div>
